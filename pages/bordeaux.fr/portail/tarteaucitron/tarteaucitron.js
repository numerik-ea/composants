...
var tarteaucitron = {
        ...
        tarteaucitron.addInternalScript(pathToLang, '', function () {
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                html += '<button type="button" id="tarteaucitronBack" aria-hidden="true" aria-label="' + tarteaucitron.lang.close + '"></button>';
    ...
    "engage": function (id) {
        ...
        html += '      ' + engage + '<a href="#tarteaucitron" class="standard_link block margin_bottom_15" >Gérer les cookies pour bordeaux.fr</a>';
